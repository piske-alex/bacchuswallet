...
var WalletComponent = /** @class */ (function () {
    ...
    WalletComponent.prototype.ngOnInit = function () {
        ...
        this.walletservice.auth(this.user)
            ...
            _this.baccbalance = Math.floor(user.result * 700 / 1000000000000000000);
            console.log(user);
        });
    };
